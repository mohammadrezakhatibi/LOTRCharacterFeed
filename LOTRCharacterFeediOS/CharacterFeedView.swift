...
struct CharacterFeedView_Previews: PreviewProvider {
    static var previews: some View {
        let mockCharacters = [
            CharacterFeedViewModel(id: UUID().uuidString, name: "Aragorn II Elessar", race: "Human", imageURL: URL(string: "https://lokomond.com/lotr/characters/images/Aragorn_II_Elessar.jpg")!),
            CharacterFeedViewModel(id: UUID().uuidString, name: "Frodo Baggins", race: "Hobbit", imageURL: URL(string: "https://lokomond.com/lotr/characters/images/Frodo_Baggins.jpg")!),
        ]
        Group {
